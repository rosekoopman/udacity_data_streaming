...
class ClickEvent:
    ...
    schema = parse_schema(original_schema)
    ...
    def serialize(self):
        ...
        # kafka-console-consumer --topic "com.udacity.lesson3.exercise2.clicks" --bootstrap-server localhost:9092 --from-beginning
        #
        # return json.dumps(
