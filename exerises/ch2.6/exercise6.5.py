...
async def clickevent(clickevents):
    ...
    # Note to myself: processor(s) needs to be added before the loop!
...
# python exercise6.5.py worker    
# kafka-console-consumer --topic com.udacity.streams.clickevents.scored --bootstrap-server localhost:9092