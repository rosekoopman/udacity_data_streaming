...
from pyspark.sql.types import StructField, StructType, StringType, BooleanType, ArrayType, DateType, IntegerType, FloatType, LongType
...
# used as key?
# Set type to LongType --> the Int gets too large for the allowed size of an integer!
# See: https://knowledge.udacity.com/questions/774553
...
# Note: now I have two transactionId columns! This makes it impossible to select the column transactionId as key (because ambiguous column error). I will use another field as key to mitigate.
...
# kafka-console-consumer --topic withdrawals-location --bootstrap-server localhost:9092 --from-beginning