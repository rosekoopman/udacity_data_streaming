...
# check messages in topic with
# kafka-console-consumer --topic "ex4.2.logs" --bootstrap-server localhost:9092
# check messages in logfile with
# tail /tmp/exercise2.log