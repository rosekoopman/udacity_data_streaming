...
async def consume(topic_name):
    ...
    c = Consumer({"bootstrap.servers": BROKER_URL, "group.id":"my-first-python-kafka-group"})
...
def main():
    ...
    topic = NewTopic("my-first-python-topic", num_partitions=1, replication_factor=1)
