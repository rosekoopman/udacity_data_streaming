...
class Station(Producer):
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        logger.info(f"Produce arrival message: {self.color.name} - {self.station_id} - {train.train_id} - {train.status.name}")
        
        # Note: no need to provide key_schema and value_schema because this is done upon initialization of AvroProducer
...
# check if schemas are stored in registry
