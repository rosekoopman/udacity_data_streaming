...
# create schemas for redis and customer
# Note: stedi-event is not used in this script so no schema is made
...
# write customer stream to the console
customer_stream_df.writeStream.outputMode("append").format("console").start().awaitTermination()
...
# JSON: {"customer":"Ashley.Wu@test.com","score":3.5,"riskDate":"2022-01-05T10:47:00.738Z"}
